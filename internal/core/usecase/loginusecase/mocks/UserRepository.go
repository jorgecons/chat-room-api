...
func (_m *UserRepository) Get(_a0 context.Context, _a1 string) (domain.User, error) {
...
func (_c *UserRepository_Get_Call) Return(_a0 domain.User, _a1 error) *UserRepository_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *UserRepository_Get_Call) RunAndReturn(run func(context.Context, string) (domain.User, error)) *UserRepository_Get_Call {
	_c.Call.Return(run)
	return _c
}
